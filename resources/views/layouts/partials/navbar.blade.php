<div class="nav-header">
    <a href="/" class="brand-logo">
        <svg class="logo-abbr" width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink">
            <g filter="url(#filter0_d_2_3)">
                <rect x="4" width="50" height="50" fill="url(#pattern0)" shape-rendering="crispEdges" />
            </g>
            <rect class="inner-svg" x="20.816" y="6.30162" width="30.9845" height="22.1987" rx="5"
                transform="rotate(28.9493 20.816 6.30162)" fill="var(--primary)" />
            <defs>
                <filter id="filter0_d_2_3" x="0" y="0" width="58" height="58" filterUnits="userSpaceOnUse"
